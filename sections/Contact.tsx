...
export default function Contact() {
  ...
  return (
    <footer className="flex flex-col items-start gap-2.5 pt-6 pb-[50px] px-40 w-full bg-[#52525226] relative">
      ...
      <div className="flex items-start gap-2.5 px-0 pb-1 pt-6 w-full">
        <form
          onSubmit={(e) => e.preventDefault()}
          className="flex flex-col items-start gap-6 pl-0 pr-5 py-0 flex-1 grow"
        >
          <label htmlFor="name" className="w-full relative z-50">
            <input
              ...
              className="peer w-full items-center px-5 py-2.5 bg-[#52525226] rounded border border-solid border-neutral-700 text-neutral-400 text-base font-semibold outline-0 focus:border-[#e2e2e2] focus:placeholder-transparent"
            />
            <span
            className={`absolute text-neutral-400 py-[1px] font-semibold text-base rounded px-2 left-3 ${!!formData.name ? "-top-[18px] opacity-100" : "top-[10px] opacity-0  peer-focus:opacity-100 peer-focus:-top-[18px]" } bg-[#525252] peer-focus:border peer-focused:border-[#e2e2e2] transition-all duration-200`}
            >
              Name
            </span>
          </label>
          ...
          <label htmlFor="name" className="w-full relative z-50">
            ...
            />
             <span
            className={`absolute text-neutral-400 py-[1px] font-semibold text-base rounded px-2 left-3 ${!!formData.email ? "-top-[18px] opacity-100" : "top-[10px] opacity-0  peer-focus:opacity-100 peer-focus:-top-[18px]" } bg-[#525252] peer-focus:border peer-focused:border-[#e2e2e2] transition-all duration-200`}
            >
              Emaill
            </span>
          </label>
          ...
          <textarea
            placeholder="Message"
            required
            className="flex items-start gap-2.5 pt-2.5 px-5 max-w-full text-wrap max-h-[160px] h-[160px] w-full bg-[#52525226] rounded border border-solid border-neutral-700 text-neutral-400 text-base font-semibold outline-0 focus:border-[#e2e2e2]"
          />
