  ...
  return (
    <div className="inline-flex flex-col items-start gap-3 px-0 py-4">
      ...
      <div className="inline-flex flex-col items-start gap-2.5 pl-6 pr-2 py-0">
        <Card className="inline-flex flex-col items-start px-5 py-3 bg-semi-transparent rounded-[5px] border border-solid border-neutral-700">
          <CardContent className="p-0">
            ...
            <div className="flex md:w-[280px] w-[224px] items-center gap-2.5 px-0 py-2">
              <p className="relative flex-1 font-light text-wrap text-foreground md:text-sm text-xs tracking-[0] leading-[normal]">
