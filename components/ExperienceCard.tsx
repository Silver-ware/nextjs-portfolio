  ...
  return (
    <div
      className={`inline-flex  flex-col items-start gap-3 px-0 py-4 w-fit ${
        !experience.relevant && "opacity-50"
        ...
        <Card className="inline-flex w-fit flex-col items-start px-5 py-3 bg-background rounded-[5px] border border-solid border-neutral-700">
          <CardContent className="p-0 w-fit max-w-[312px] min-w-[264px]">
            ...
            <div className="flex w-full items-center gap-2.5 px-0 py-2">
              <span className="relative w-full flex-1 font-light text-wrap text-foreground md:text-sm text-xs tracking-[0] leading-[normal]">
        ...
        {experience.contributions && (
          <Popover>
            <PopoverTrigger asChild>
              <div className="group-hover:-translate-y-[100%] z-[-1] group-hover:opacity-100 h-fit opacity-0 transition-all duration-300 ease-in-out absolute flex items-center gap-1 top-0 -translate-y-[80%] bg-semi-transparent px-3 py-1 backdrop-blur-xs rounded-t-sm right-3 text-foreground border-x border-t border-neutral-700 w-fit select-none">
            ...
            <PopoverContent
              align="start"
              side="right"
              className="bg-semi-transparent backdrop-blur-md text-foreground mx-2 border-neutral-700"
            >
              <span className="block leading-4 text-center font-medium text-base">{experience.contributions.heading}</span>
